...
| **Commit** | The act of flushing a Pi Session to OpenViking to trigger background memory extraction | save, persist |
...
- A **Commit** operates on an **OV Session** and produces a **Task ID**
...
>
> **Domain expert:** "Only when the user explicitly asks to save. **Commit** triggers the background extraction that produces **Memories** — it's not automatic per turn."
